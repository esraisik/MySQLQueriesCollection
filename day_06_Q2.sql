...
/*
    ...
    actual degeri alip expected ile karsilastirabilirz
...
/*  Urun tablosundan Ali Can'in aldigi urunun ismini, ----> PHONE
tedarik tablosunda irtibat Merve Temiz olan sirketin ismi ----> APPLE
 ile degistirin. 
*/

UPDATE urun
SET urun_İsmi = (SELECT isim 
				 FROM tedarik
...
-- urun tablosu child tablo oldugundan once foreıgn key olan tedarikci_id'nin
-- parent tabloya eklenmesi gerekir.

INSERT INTO tedarik VALUES(104,'Huawei', 'Serat Yildiz');

-- urun tablosunda musteri_isim degeri Fatma olan tedarikcinin tedarikci_id'sini 110 yapin

UPDATE urun
SET tedarikci_id = 110
WHERE musteri_isim= 'Fatma';

-- urun tablosu child tablo oldugundan once foreıgn key olan tedarikci_id 110'un
-- parent tabloya eklenmesi gerekir

INSERT INTO tedarik VALUES(110,'XIAOMI', 'Anil Ozdem');
